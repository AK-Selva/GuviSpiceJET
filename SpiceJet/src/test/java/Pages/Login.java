...
//		element.click();
	...
	public String validLoginDetails() throws InterruptedException {
		WebElement Mobileelement = webDriver.findElement(
				By.xpath("//div[@class='css-76zvg2 r-homxoj r-ubezar r-1ozqkpa'][normalize-space()='Mobile Number']"));
		Mobileelement.click();
		WebElement element = webDriver.findElement(By.xpath("//input[@data-testid='user-mobileno-input-box']"));
		element.click();
		element.sendKeys("9874563211");
		Thread.sleep(1000);
		...
		WebElement SubmitElement = webDriver.findElement(By.xpath(
		...
		//if (wait.until(ExpectedConditions.visibilityOf( webDriver.findElement(By
				//.xpath("//div[@class='css-1dbjc4n r-14lw9ot r-1p0dtai r-1pcd2l5 r-wk8lta r-u8s1d r-zchlnj r-ipm5af']")))) != null)
			return "visible";
